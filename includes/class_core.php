...
define('FILE_VERSION', '3.7.4'); // this should match install.php
define('SIMPLE_VERSION', '374'); // see vB_Datastore::check_options()
define('YUI_VERSION', '2.6.0'); // define the YUI version we bundle
...
*
* @package	vBulletin
* @version	$Revision: 28279 $
* @date		$Date: 2008-11-03 09:23:01 -0600 (Mon, 03 Nov 2008) $
*/
class vB_Database
{
	/**

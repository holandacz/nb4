...
$upgrade_phrases['upgrade_373.php']['weak_password_notice'] = 'Weak Password Notice';
$upgrade_phrases['upgrade_373.php']['weak_password_description'] = 'In this version, users may no longer set their password to be the same as their username. Users affected by this will be forced to change their password on their first login. Additionally, a tool has been added to the Admin Control Panel to reset these users\' passwords.';
$upgrade_phrases['upgrade_373.php']['steps'] = array(
	1 => 'Upgrade to vBulletin ' . VERSION . ' Complete!'
);

$upgrade_phrases['upgrade_374.php']['steps'] = array(
	1 => 'Upgrade to vBulletin ' . VERSION . ' Complete!'
);

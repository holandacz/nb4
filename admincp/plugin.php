...
define('CVS_REVISION', '$RCSfile$ - $Revision: 28107 $');
...
// Start Code
// #############################################################################
if (!isset($_REQUEST['do']) OR $_REQUEST['do'] == 'modify' OR $_REQUEST['do'] == 'product')
{
...
if ($_REQUEST['do'] == 'update' AND isset($_REQUEST['return']))
{
	function plugin_update_handler($buffer)
	{
		global $vbulletin;
		exec_header_redirect('plugin.php?do=edit&pluginid=' . $vbulletin->GPC['pluginid']);
	}
...
if ($_REQUEST['do'] == 'modify')
{
	...
	while ($plugin = $db->fetch_array($plugins))
	{
		...
		/* lwe change
		// http://www.vbulletin.org/forum/showthread.php?t=194036

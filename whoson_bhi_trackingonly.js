...
var sWOGateway       = "gateway6.whoson.com";    // specify the address:port of the WhosOn Gateway server
var sWOGatewaySSL    = "gateway6.whoson.com"; // specify the address:port of the WhosOn Gateway server SSL interface
var sWODomain        = "www.noblood.org";  // the domain you are monitoring
var sWODepartment    = ""; // optional department
var sWOChatstart     = "https://gateway6.whoson.com/chat/chatstart.htm"; // url to the chatstart.htm page

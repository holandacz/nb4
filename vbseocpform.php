...
vbseo_display_option_formats($alang['groupshomepage_format_desc'], 'groupshomepageformat', 
array(
'groups/index[page].html',
'groups/index[page]/',
), 
...
if(!$sw_a) $sw_a = explode('|',VBSEO_LINKBACK_BLACKLIST);
foreach($sw_a as $v){
echo "\n".($v)."";
}
?></textarea></td>
...
<td><input name="member_meta_description" type="text" id="length_meta_description" size="70" value="<?php echo VBSEO_META_DESCRIPTION_MEMBER?>"></td>
</tr>
<tr class=subheader>

 ...
 * @lastmodified	$Date: 2007-10-21 16:29:57 -0700 (Sun, 21 Oct 2007) $
 */
...
$upload_dir = "/Applications/MAMP/htdocs/uptest"; // Directory for file storing
                                            // filesystem path


$web_upload_dir = "/uptest"; // Directory for file storing
                          // Web-Server dir 
...
END;
    ...
    header("Location: http://".$_SERVER['HTTP_HOST'].'uploadtest.php'); 
    exit(); 
...
<form action="uploadtest.php" target="upload_iframe" method="post" enctype="multipart/form-data">

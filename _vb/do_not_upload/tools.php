...
define('VERSION', '3.7.3 Patch Level 1');
define('THIS_SCRIPT', 'tools.php');
define('VB_AREA', 'tools');

if (strlen('96c32c41a2e3ed7b6d12a558375c9433') == 32)
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', '96c32c41a2e3ed7b6d12a558375c9433');
}
else
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', md5(strtoupper('96c32c41a2e3ed7b6d12a558375c9433')));
}
...
<p align="center" class="smallfont"><a href="http://www.vbulletin.com/" target="_blank" class="copyright">vBulletin <?php echo VERSION; ?>, Copyright &copy;2000-<?php echo date('Y'); ?>, Jelsoft Enterprises Ltd</a></p>
</body>
</html>
<?php

...
*
* @package	vBulletin
* @version	$Revision: 27322 $
* @date		$Date: 2008-08-01 06:15:21 -0500 (Fri, 01 Aug 2008) $
*/
class vB_PaidSubscriptionMethod_authorizenet extends vB_PaidSubscriptionMethod
{
	...
	*/
	function test()
	{
		return (!empty($this->settings['authorize_loginid']) AND !empty($this->settings['authorize_md5secret']));
	}

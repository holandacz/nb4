...
$_SP[14] = "Block has already been selected.";
$_SP[15] = "Block Nr. %s can not be selected.";
$_SP[16] = "Block Nr. %s has already been reserved.";
$_SP[17] = "No regular block selected.";
$_SP[18] = "The block you clicked is not next to another block. Both blocks need to be next to each other.";
$_SP[19] = "You can choose up to %s blocks.";
$_SP[20] = "Link the blocks";
$_SP[21] = "Choose the blocks once again";
$_SP[22] = "Save link";
$_SP[23] = "Upload";
$_SP[24] = "Choose up to %s free blocks:";
$_SP[25] = "Choose blocks:";
$_SP[26] = "Amount:";
$_SP[27] = "Block selected";
$_SP[28] = "Blocks selected";
...
$_SP[79] = "<br>You must select at least %s blocks.";

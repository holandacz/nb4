...
$vbseo_dat_folder_addon = 'vbseo_sitemap/addons/';
//echo "Run Addons $vbseo_dat_folder_addon<br>";
//echo print_r($addons);
foreach($addons as $addon)
if($addon && file_exists($vbseo_dat_folder_addon . $addon . '.php'))
{
	//echo "Addon: $addon<br>";
	vbseo_log_entry("[addon module] $addon" . '.php', true);
	include ($vbseo_dat_folder_addon . $addon . '.php');
}

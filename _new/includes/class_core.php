...
define('FILE_VERSION', '3.7.3'); // this should match install.php
define('SIMPLE_VERSION', '373'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 27532 $
* @date		$Date: 2008-08-22 04:55:59 -0500 (Fri, 22 Aug 2008) $
*/
class vB_Database
{
	/**

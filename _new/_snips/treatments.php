...
$lst[] = array("tag" => "Bloodless/blood conservation techniques", "name" => "Bloodless/blood conservation techniques", "subs" => "Bloodless/blood conservation techniques");
...
$lst[] = array("tag" => "Erythropoietin", "name" => "Erythropoietin", "subs" => "Erythropoietin");
